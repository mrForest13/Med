...
(1,7,5,2,TO_DATE('2017-01-02 15:30','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-02 16:30','YYYY-MM-DD HH24:MI'),0,'PLN','Y','')
into visit values
(2,7,5,1,TO_DATE('2017-01-15 16:30','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-15 17:00','YYYY-MM-DD HH24:MI'),100,'PLN','N','')
into visit values
(3,8,2,'',TO_DATE('2017-01-19 16:30','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-19 17:00','YYYY-MM-DD HH24:MI'),100,'PLN','N','')
into visit values
(4,8,2,'',TO_DATE('2017-01-19 18:30','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-19 19:00','YYYY-MM-DD HH24:MI'),100,'PLN','N','')
into visit values
(5,8,2,1,TO_DATE('2017-01-03 16:30','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-03 17:00','YYYY-MM-DD HH24:MI'),100,'PLN','Y','')
into visit values
(6,7,3,'',TO_DATE('2017-01-18 17:30','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-18 18:00','YYYY-MM-DD HH24:MI'),100,'PLN','N','')
into visit values
(7,7,3,'',TO_DATE('2017-01-16 11:30','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-16 12:00','YYYY-MM-DD HH24:MI'),100,'PLN','N','')
into visit values
(8,7,3,'',TO_DATE('2017-01-16 12:00','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-16 12:30','YYYY-MM-DD HH24:MI'),100,'PLN','N','')
into visit values
(9,7,3,1,TO_DATE('2017-01-05 13:30','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-05 14:00','YYYY-MM-DD HH24:MI'),100,'PLN','Y','')
into visit values
(10,8,7,'',TO_DATE('2017-01-17 16:30','YYYY-MM-DD HH24:MI'),TO_DATE('2017-01-17 17:00','YYYY-MM-DD HH24:MI'),100,'PLN','N','')
into visit values
(11,7,7,1,TO_DATE('2017-01-02 15:30','YYYY-MM-DD HH24:MI'),TO_DATE('2016-01-02 16:30','YYYY-MM-DD HH24:MI'),0,'PLN','Y','')
into visit values
