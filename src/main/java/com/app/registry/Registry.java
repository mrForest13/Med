...
import com.app.model.medical.finder.MedicamentFinder;
...
public class Registry {
	...
	private IFinderAll<Medicament> medicamentFinder = new MedicamentFinder();
	...
	public static IFinderAll<Medicament> medicamentFinder() {
		return getInstance().medicamentFinder;
	}
}
